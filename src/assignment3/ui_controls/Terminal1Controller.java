...
/**
 *
 * Class that controls the first terminal pane. It has minimal code because it inherits most of the needed
...
public class Terminal1Controller extends InfoPaneController {

	/**
	 * Spawns a new thread, which will be updating the first terminal pane.
