...
/**
 *
 * Class that controls the third terminal pane. It has minimal code because it inherits most of the needed
...
public class Terminal3Controller extends InfoPaneController {

	/**
	 * Spawns a new thread, which will be updating the third terminal pane.
