...
/**
 *
 * Class that controls the first pane (database 1). It has minimal code because it inherits most of the needed
...
public class DB1PaneController extends InfoPaneController {

	/**
	 * Spawns a new thread, which will be updating the Database 1 Pane.
	 * @param filePath -- path to the file containing the mock database entries (flights_db_1.txt)
	 */
    @Override
